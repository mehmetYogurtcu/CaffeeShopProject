...
public class KSDKPSPublicSoap
{
    ...
    public KSDKPSPublicSoap(){}

    public KSDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KSDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KSDExtendedSoapSerializationEnvelope envelope= new KSDExtendedSoapSerializationEnvelope(KSDExtendedSoapSerializationEnvelope.VER11);
