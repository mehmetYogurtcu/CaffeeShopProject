...
public class KSDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KSDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KSDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KSDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KSDDateTimeConverter dateTimeConverter = new KSDStandardDateTimeConverter();

    public KSDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KSDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KSDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KSDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KSDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KSDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
